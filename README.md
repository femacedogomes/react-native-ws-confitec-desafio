Este é um aplicativo de mensagens desenvolvido em React Native, utilizando TypeScript como base. Ele se conecta a um WebSocket local para comunicação em tempo real.
